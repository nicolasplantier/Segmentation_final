...
if __name__ == "__main__":
    ...
    filenames = ["..\\test\\An2019-1-1-3_patch5edges.txt",
                    "..\\test\\An2019-1-1-2_patch11edges.txt",
                    "..\\test\\An2019-0-0-3_patch9edges.txt"]
    for filename in tqdm(filenames):
        ...
        for i in range(len(tetrapods)):
            np.savetxt(filename[:-9] + f'_tetramask{i}', tetrapods[i])
